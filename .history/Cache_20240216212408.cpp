...
int main(int argc, char *argv[])
{
    if (argc != 6)
    {
        std::cerr << "Usage: " << argv[0] << " <input_file> <cache_size> <associativity> <block_size> <address_range>" << std::endl;
        return 1;
    }
    ...
    while (inputFile >> std::hex >> address && address <= std::stoul(argv[5], nullptr, 0))
    {
